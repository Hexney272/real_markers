...
const iconMap = {
  wrench:'icons/real_marker_wrench_v2.png',
  document:'icons/real_marker_document_v2.png',
  car:'icons/real_marker_car_v2.png',
  basket:'icons/real_marker_basket_v2.png',
  bank:'icons/real_marker_bank_v2.png',
  shield:'icons/real_marker_shield_v2.png',
  shield_star:'icons/real_marker_shield_v2.png',
  hospital:'icons/real_marker_hospital_v2.png',
  warning:'icons/real_warning.svg',
  house:'icons/real_house.svg',
  fuel:'icons/real_marker_fuel_v2.png',
  clothing:'icons/real_marker_clothing_v2.png',
  crown:'icons/real_marker_star_v2.png',
  diamond:'icons/real_marker_star_v2.png',
  mask:'icons/real_mask.svg',
  briefcase:'icons/real_marker_document_v2.png',
  users:'icons/real_marker_shield_v2.png',
  star:'icons/real_marker_star_v2.png',
  truck:'icons/real_marker_car_v2.png',
  atm:'icons/real_marker_bank_v2.png',
  gear:'icons/real_marker_wrench_v2.png',
  key:'icons/real_key.svg',
  handshake:'icons/real_handshake.svg',
  chart:'icons/real_marker_document_v2.png',
  taxi:'icons/real_marker_car_v2.png',
  box:'icons/real_marker_document_v2.png',
  fishing:'icons/real_star.svg',
  pickaxe:'icons/real_wrench.svg',
  droplet:'icons/real_marker_fuel_v2.png'
};
