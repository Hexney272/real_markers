...
const iconMap = {
  wrench:'icons/real_wrench.svg',
  document:'icons/real_document.svg',
  car:'icons/real_car.svg',
  basket:'icons/real_basket.svg',
  bank:'icons/real_bank.svg',
  shield:'icons/real_shield_star.svg',
  shield_star:'icons/real_shield_star.svg',
  hospital:'icons/real_hospital.svg',
  warning:'icons/real_warning.svg',
  house:'icons/real_house.svg',
  fuel:'icons/real_fuel.svg',
  clothing:'icons/real_clothing.svg',
  crown:'icons/real_diamond.svg',
  diamond:'icons/real_diamond.svg',
  mask:'icons/real_mask.svg',
  briefcase:'icons/real_briefcase.svg',
  users:'icons/real_users.svg',
  star:'icons/real_star.svg',
  truck:'icons/real_truck.svg',
  atm:'icons/real_atm.svg',
  gear:'icons/real_gear.svg',
  key:'icons/real_key.svg',
  handshake:'icons/real_handshake.svg',
  chart:'icons/real_briefcase.svg',
  taxi:'icons/real_car.svg',
  box:'icons/real_handshake.svg'
};
